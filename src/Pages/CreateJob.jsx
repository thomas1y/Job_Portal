      ...
      <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
         <div className='create-job-flex'>
           ...
           <div className='lg:w-1/2 w-full'>
              ...
              {...register("jobcompanyName")} className='create-job-input'/>
           </div> 
         </div>
         ...
         <div className='lg:w-1/2 w-full'>
              ...
              <input type="text" placeholder='Ex: 2023-10-28'
         ...
         <div>
         <label className='block mb-2 text-lg'>Required Skll Sets:</label>
          <CreatableSelect 
