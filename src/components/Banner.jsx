    ...
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
        ...
        <form>
            <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
                <div className='flex md:rounded-s-md shadow-sm ring-1 ring-insert focus-within:ring-2 focus-within:ring-insert focus-within:ring-indigo-600 md:w-1/2 w-full'>
                ...
                <div className='flex md:rounded-s-none shadow-sm ring-1 ring-insert focus-within:ring-2 focus-within:ring-insert focus-within:ring-indigo-600 md:w-1/5 w-full'>
